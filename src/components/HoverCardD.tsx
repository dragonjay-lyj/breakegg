...
const HoverCardD = ({ tsrc, username, tdes, thref, tpubDate, pixiv }) => {
  ...
  <HoverCardTrigger asChild>
    <div className="grid grid-cols-2" data-aos="fade-up">
      <div className="aspect-square h-full w-full overflow-hidden rounded-2xl bg-blue-50 shadow-md duration-300 hover:scale-[1.05] md:h-56 md:shadow-none">
        <div className="dark:bg-[#111827] flex h-2/3 flex-row justify-center gap-4 bg-white md:h-3/5 md:justify-evenly">
        ...
        <div className="dark:bg-[#111827] flex h-1/3 flex-row items-center justify-evenly bg-gray-50 md:h-2/5">
